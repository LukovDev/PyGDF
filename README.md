...
- [ ] **Сделать 2D освещение:**
  ...
  - [ ] Сделать поддержку теней (путём raycast).
...
- [ ] **Сделать чтобы 2D освещение могло испускать лучи и делать динамические тени, а также отражения и преломления. Что-то типа RTX в 2D.**
