...
### Документация по API ядра фреймворка есть [тут.](https://github.com/LukovDev/PyGDF/blob/master/README_API.md)</br>
...
### Важно!
После того как вы установили ```Python 3.11.x``` и убедились что он работает в консоле, запустите файл ```pypi.bat``` в папке проекта (фреймворка), чтобы установить все необходимые библиотеки для работы фреймворка.</br>
...
- [ ] **Переписать 2D физику:**
  ...
  - [ ] Добавить функцию для физического объекта, чтобы можно было получить список физ.объектов с которыми он сталкивается.
...
Версии состоят от одного до двух подразделений. Что это значит.</br>
```0.0``` - Одноступенчатое разделение версии.</br>
```0.0.0``` - Двухступенчатое разделение версии.</br>

Где первое число - Номер версии (основная версия проекта).</br>
Где второе число - Подразделение версии (версии относящиеся к основной версии в виде исправления ошибок и улучшений).</br>
Где третье число - Подразделение подразделённой версии (версии относящиеся как "небольшие изменения и улучшения" к одноступенчатой версии).</br>

В начале номера версии может быть приписана буква ```v``` означающая что это является версией программы. Например ```v1.0```.</br>

Также к версии могут быть приписаны приставки ```-a``` и ```-b``` что означает ```-alpha``` и ```-beta``` соответственно.</br>

К этим приставкам могут быть приписаны цифры (например ```v1.0-b1```), что означает номер альфа или бета версии в виде улучшений и исправления ошибок альфа или бета версии.</br>

Подробнее об **нумерации версий программного обеспечения** можете почитать на [**Wiki**](https://ru.wikipedia.org/wiki/%D0%9D%D1%83%D0%BC%D0%B5%D1%80%D0%B0%D1%86%D0%B8%D1%8F_%D0%B2%D0%B5%D1%80%D1%81%D0%B8%D0%B9_%D0%BF%D1%80%D0%BE%D0%B3%D1%80%D0%B0%D0%BC%D0%BC%D0%BD%D0%BE%D0%B3%D0%BE_%D0%BE%D0%B1%D0%B5%D1%81%D0%BF%D0%B5%D1%87%D0%B5%D0%BD%D0%B8%D1%8F)

ПОЖАЛУЙСТА. Я ВАС ПРОШУ. СОБЛЮДАЙТЕ ПРАВИЛЬНУЮ НУМЕРАЦИЮ ВЕРСИЙ СВОИХ ПРОГРАММ. УЧИТЕСЬ ПРАВИЛЬНО И НЕ НУМЕРУЙТЕ НЕПОНЯТНО КАК.

_Эту схему версий можно использовать и в ваших играх при желании. Эта схема максимально просто и правильно описывает всю суть обновлений п.о._
